...
function black() {
  return [
    ...
    "During an alien abduction, __________ occurred.",
    "As a sacrifice, the people of the village offered __________.",
    "During a basketball game the crowd chanted: __________ .",
    "__________ happened loudly in the middle of Cards Against Humanity.",
    "Joining the elite league of superheroes is __________ -man.",
    "Due to the efforts of a hacker group, __________ was broadcast on the news instead of the President’s message.",
    "Love is an open __________.",
    "Conceal it, don’t __________ it.",
    "Today a man was stopped at customs for concealing __________ in his trenchcoat.",
    "Fan’s complained after a scene from the Avengers with Black Widow __________ was deleted.",
    "I have had it with these motherfucking __________ on this motherfucking plane!",
    "Then he knew, he shouldn’t have __________",
    "Please Stop.... No, Not __________!!!",
    "Waiter! I have a __________ in my soup!",
    "It’s only __________. Everyone does it.",
    "I’m not a psychopath, I’m a high functioning __________.",
    "As the __________ was inserted into my mouth I began to...",
    "Thanks to __________, I contracted Ebola.",
    "When the little girl cracked open the egg, she found __________.",
    "The Westboro Baptist Church recently protested over the introduction of __________.",
    "__________-ception.",
    "Got __________ ?",
    "__________ Only in Bangkok",
    "while(true) {__________}",
    "Luke, I am your __________.",
    "Tonight the Chef’s Special will include: __________ .",
    "For one night only, the Pantages Theater will host a performance of __________.",
    "During the Health class the teacher mistakenly showed the students __________ instead of The Power of Abstinence: A Film.",
    "Miley Cyrus’s latest performance raised eyebrows when she __________ on stage.",
    "You divided by zero, therefore __________ happened.",
    "__________? Thanks Obama.",
    "“It’s simple,” said Hermione, “Just swish and __________.”",
    "And then it all changed when the __________ attacked.",
    "Tonight on the Discovery Channel, we will show __________ in it’s natural habitat.",
...
function white() {
  return [
   ...
   "Hades",
   "Hell",
   "Jesus praying to Satan",
   "Stonehenge",
   "Catholic School Girl",
   "Darth Vader breathing",
   "Hail Hydra!",
   "Oliver Wood’s broomstick",
   "Harry Potter’s wand",
   "Princess Leia in a golden bikini",
   "Harem Haven",
   "Let it go!",
   "Dan Bilzerian",
   "White Slave Owners",
   "White People",
   "So did the fat chick",
